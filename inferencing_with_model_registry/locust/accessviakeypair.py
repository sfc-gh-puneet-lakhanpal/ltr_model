...
def get_jwt(account:str, user:str, private_key_file_path:str, endpoint:str, role:str, lifetime:int=59, renewal_delay:int=54, endpoint_path:str='/', snowflake_account_url:str=None):
